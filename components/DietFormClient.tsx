...
const QUESTIONS = {
  ...
  "4FED": [
    ...
    "Do you read ingredient labels for 4FED compliance?",
    "How do you plan your grocery shopping for 4FED?",
    "Do you cook most of your meals at home while on 4FED?",
    "How do you manage cravings for eliminated foods?",
    "What resources do you use for 4FED information?",
    "Do you follow any specific 4FED protocol variations?",
    "How do you educate others about 4FED?",
    "What is your go-to 4FED snack?",
    "How do you track your symptoms and food reintroduction?",
    "What advice would you give to someone starting 4FED?",
  ],
};
